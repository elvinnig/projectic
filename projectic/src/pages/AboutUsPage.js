                ...
                <div className="row align-items-center justify-content-center">
                    ...
                    <img className='about-us' alt='ian' src={ian}/>
                        ...
                        <p>
                            ...
                            <div class="modal fade" id="ian" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog about-modal">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">More Info</h1>
                    ...
                    <div className="col-6 col-sm-3">
                        ...
                        <p>
                            ...
                            <div class="modal fade" id="wren" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog about-modal">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">More Info</h1>
                    ...
                    <div className="col-6 col-sm-3">
                        ...
                        <p>
                            ...
                            <div class="modal fade" id="elvin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog about-modal">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">More Info</h1>
                    ...
                    <div className="col-6 col-sm-3">
                        ...
                        <p>
                            ...
                            <div class="modal fade" id="ed" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog about-modal">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">More Info</h1>
