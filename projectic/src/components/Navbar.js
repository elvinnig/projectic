            ...
            <div className='container'>
                <div className='d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start'>
                    ...
                    <ul className='nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0'>
                        <li><a href='#landing' className='nav-link px-3 link-dark lead'>Why Projectic</a></li>
                        <li><a href='#features' className='nav-link px-3 link-dark lead'>Features</a></li>
                        <li><a href='#contact' className='nav-link px-3 link-dark lead'>Contact Us</a></li>
                    </ul>
                    {/* Login Navigation */}
